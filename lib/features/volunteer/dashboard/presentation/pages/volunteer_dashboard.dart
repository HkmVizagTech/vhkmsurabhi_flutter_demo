    ...
    return AppScaffold(
      ...
      bottomNavItems: [
        ...
        AppBottomNavItem(
          ...
          label: 'Search Donor',
          onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const DonorLookupPage(color: color))),
        ),
        AppBottomNavItem(
          icon: Icons.qr_code_scanner,
          label: 'QR Scanner',
          onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const QrScannerPage())),
        ),
